...
let { email, password } = require('./secrets'); // so that we keep our credentials (like email and pass) safe and avoid unwanted attacks
// let email = "";
// let password = "";
...
let browserOpenPromise = puppeteer.launch({
  ...
  //chrome://version/
  // executablePath:
  //   "//Applications/Google Chrome.app/Contents/linux/Google Chrome",
});
...
browserOpenPromise //fulfill
  ...
  .then(function (linksArr) {
    ...
    let questionWillBeSolvedPromise = questionSolver(linksArr[0], 0); // we can avoid this and run the for loop from zero. This is just for explanatory purpose.
